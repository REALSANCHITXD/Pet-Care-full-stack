...
def db_filter_products(session: Session, category: Optional[str] = None, price_up: Optional[float] = None, price_down: Optional[float] = None, rating: Optional[float] = None):
